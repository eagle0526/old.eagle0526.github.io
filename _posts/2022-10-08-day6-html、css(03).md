...
```markdown
<div class="flex">
    <div class="item">1 教學對付選項認定世紀刺激影視意見，成為德國涉及大小完善效率照片顏色第二建議界面職務一副，無限聲明玻璃交給，判斷設計一聲滑鼠提問大家拿出感覺到祝福帳號，剛才失敗細節意外組合天堂大學生一部分程度一位增長你可以，執行警察沉默常用紀念理解加油身材像素背後，想想應。</div>
    <div class="item">2</div>
    <div class="item">3</div>
</div>
...
------
如果使用auto，左 or 右可以取得剩餘空間 (剩餘空間分配)
