...
使用form_for，如果你今天new了一個實體，流水編號為3，這時候你把它刪除了，接著再new一次，新的實體的流水編號會變4
...
<%= form_with (model: @wishlist) do |from| %>
