...
不過這時候會發生一個錯誤，ActionController，這個是什麼呢？？  
...
> --  
> authenticity_token -> config檔案裡面有一個master key 非常重要，key掉了，就爆了  
> --  
{: .block-warning}
...
controller更改，model.new實體在controller做，  
```md
> def new_wish
